...
#if LV_MEM_CUSTOM == 0 && LV_MEM_SIZE < (48ul * 1024ul)
...
void lv_demo_widgets(void)
{
    ...
    lv_obj_t * t1 = lv_tabview_add_tab(tv, "Una Gatita");
    lv_obj_t * t2 = lv_tabview_add_tab(tv, "Estadisticas");
    lv_obj_t * t3 = lv_tabview_add_tab(tv, "Tiendita");
    profile_create(t1);
    analytics_create(t2);
    shop_create(t3);
...
static void profile_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(email_label, "EsaGatita@Iztapalapa.com");
    ...
    lv_label_set_text(label, "¡no tocar!");
    lv_obj_center(label);
    ...
    lv_label_set_text(label, "Invita a un Cuate");
    lv_obj_center(label);
    ...
    lv_textarea_set_placeholder_text(user_name, "tu name");
    ...
    lv_label_set_text(panel3_title, "Experiencia en el Petate?");
    lv_obj_add_style(panel3_title, &style_title, 0);

    lv_obj_t * experience_label = lv_label_create(panel3);
    lv_label_set_text(experience_label, "Experiencia en el metate");
...
static void analytics_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(title, "Mi economia");
...
void shop_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(title, "Productos mas vendidos");
    lv_obj_add_style(title, &style_title, 0);

    LV_IMG_DECLARE(img_clothes);
    create_shop_item(list, &img_clothes, "Tanga del CUbAmerica", "P/ caballero", "$722");
    create_shop_item(list, &img_clothes, "Dildo sabor Aguila", "Unixex", "$411");
    create_shop_item(list, &img_clothes, "miltivibrado con himno Aguila", "Mujer", "$917");
    create_shop_item(list, &img_clothes, "Pantalones de hombre", "Pa la banda", "$64");
    create_shop_item(list, &img_clothes, "Frijoles de Apizaco", "comida", "$805");
    ...
    lv_checkbox_set_text(cb, "@jorgealbertoescua");

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "Comparte y comenta");

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "Dale al megusta");
    lv_obj_add_state(cb, LV_STATE_CHECKED);

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "y te leo en los comentario");
    lv_obj_add_state(cb, LV_STATE_DISABLED);

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "hecho en Mexico");
